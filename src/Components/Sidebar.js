...
import img from "./Images/zafar.jpg"
...
const Sidebar = () => {
    ...
    return (
         ...
         <div className='profile text-center pt-3'>
         <img className='img' src={img} style={{width:"80px" ,height:"80px"}}/>
         <h5>Mohd Zafar</h5>
         </div>
            <ul class="nav flex-column sticky-top pl-0  p-3 mt-3 ">
